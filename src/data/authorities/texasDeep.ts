/** Texas deep authorities — Theo citation pack 2026-09-21 (P2 PASS soften). Sable may polish. */
...
export const texasDeepAuthorities: AuthorityRow[] = [
  {
    ...
    parentProtection:
      'Supports documenting whether required HB 730 notices were given. Missing notice may affect civil admissibility of what was obtained—outcomes still depend on your facts and counsel.',
  ...
  },
  {
    ...
    parentProtection:
      'Refusal without a court order is generally protected under Texas practice framing, but outcomes are fact-specific—warrant, exigency, or a court order can change the analysis.',
    officialUrl: 'https://statutes.capitol.texas.gov/Docs/FA/htm/FA.261.htm',
    secondaryUrl: 'https://capitol.texas.gov/tlodocs/88R/billtext/html/HB00730F.htm',
    lastVerified: '2026-09-21',
    confidence: 'high',
  ...
  },
  {
    ...
    parentProtection:
      'Preferred short note: Texas is generally a one-party-consent state (Penal Code § 16.02). DFPS-related recording rights also appear in Family Code § 261.307. Not legal advice.',
  ...
  },
  {
    ...
    parentProtection:
      'Supports calendar-tracking the post-removal hearing clock. Soften “always day 14” slogans—exceptions and scheduling realities exist.',
  ...
  },
  {
    ...
    parentProtection:
      'Supports tracking the drop-dead timeline and any extension findings. Do not market as an automatic win.',
