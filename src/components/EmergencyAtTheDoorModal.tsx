    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/75 p-4 overflow-y-auto">
      <div className="relative w-full max-w-2xl bg-slate-900 border-2 border-rose-600 rounded-xl shadow-2xl text-slate-100 overflow-hidden my-6">
        ...
        <div className="p-6 space-y-5 text-sm">
          ...
          <div className="bg-slate-950/70 border border-slate-800 rounded-lg p-2.5 text-[10px] text-slate-400 text-center leading-relaxed">
            <span className="font-semibold text-amber-400">Legal Notice: </span>
            This verbal script is an informational self-help reference for parents asserting constitutional and statutory protections under Texas law. It does not constitute legal counsel or guarantee agency withdrawal. In situations involving law enforcement or signed warrants, consult a licensed Texas attorney immediately.
          </div>
        </div>
