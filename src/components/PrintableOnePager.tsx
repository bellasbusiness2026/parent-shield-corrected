      ...
      <div className="flex justify-center">
        ...
        >
          ...
          <div className="text-[10px] text-slate-600 font-sans text-center pt-1 border-t border-slate-300">
            Legal Notice & Disclaimer: This document is an informational self-help administrative notice prepared by the parent. Neither ParentShield nor its creators/operators provide legal representation or assume liability for case outcomes; this does not constitute legal counsel or an attorney-client relationship. Consult a licensed Texas family law attorney for active legal representation.
          </div>
        </div>
      </div>
    </div>
